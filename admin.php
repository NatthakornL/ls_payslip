            ...
            <div class="wrapper wrapper--w960">
                <div class="card card-4">
                    ...
                    <div class="card-body">
                        ...
                        <div style="margin-top: 10px; padding: 1%; width: 100%; height: auto; border: 1px solid #FF6100; border-radius: 10px;">
                            <form method="post" action="" enctype="multipart/form-data">
                                ...
                                <li style="font-size: 20px; font-weight: 600; text-align: center; color: #FFA200;"><i class="em em-page_facing_up" aria-role="presentation" aria-label="PAGE FACING UP"></i>
                                    ตารางเเสดงข้อมูลผู้ใช้ในระบบเเจ้งเงินเดือน<i class="em em-page_facing_up" aria-role="presentation" aria-label="PAGE FACING UP"></i></li><br>

                                <li style="padding-left: 29.5%; text-align: center; font-size: 16px; display: flex; width: 100%; ">
                                    <span style="font-weight: 600; width: 18%; ">ชื่อ - นามสกุล :
                                    </span>
                                    <span style="width: 50%; text-align: left; padding-right: 3%; ">ทดสอบระบบ
                                        อัพเดทข้อมูล
                                    </span>
                                </li>
                                ...
                                <div style="display: flex; justify-items: center; justify-content: center;">
                                    <button class="btn btn--radius-2 btn--orange" type="button"><a href="imupcsv.php" style="color: #fff;" onclick="return confirm('กดยืนยันเพื่อไปยังหน้าเพิ่มข้อมูล');">เพิ่มข้อมูล</a></button>
                        ...
                        <div style="margin-top: 2px; padding: 1%; width: 100%; height: auto; border: 1px solid #FF6100; border-radius: 10px;">
                            <form method="post" action="" enctype="multipart/form-data">
                                <!------------------SEARCHZONE------------------->
                                <h3 style="text-align: center; font-weight: 600;">ค้นหาข้อมูล</h3>
                                <span style="text-align: center; "><input type="text" id="myInput" onkeyup="searchTable()" class="Input-text" placeholder="ค้นหา" style="margin-left: 30%; border: 1px solid;">
                                </span><br>
                                <!------------------END SEARCHZONE--------------->
                                <table border="1" bordercolor="#000" align="center" width="100%" border-collapse: collapse; style="margin: auto; overflow-x: hidden; padding-top: 30px; ">
                                    <li style="text-align: center; font-size: 17px; width: 100%; font-weight: 600; color: red; padding-bottom: 1%;">
                                        <i class="em em-exclamation" aria-role="presentation" aria-label="HEAVY EXCLAMATION MARK SYMBOL"></i>
                                        เเสดงข้อมูลของพนักงานทั้งหมด <i class="em em-exclamation" aria-role="presentation" aria-label="HEAVY EXCLAMATION MARK SYMBOL"></i>
                                        <span style="font-size: 16; font-weight: 600;"></span>
                                    </li>
                                    <li style="text-align: center; font-size: 14px; width: 100%; height: auto; margin-bottom: 1%; font-weight: 600; color: #888888; ">
                                        จำนวณ
                                        <span style="font-size: 16; font-weight: 600; width: 2%; color: #FF6100;">XXXX</span>
                                        <span style="font-size: 14; font-weight: 600;">คน</span>
                                    </li>
                                    <thead style="width: 100%; height: 30px; border: 1px solid #000; ">
                                        <th style="width: 5%; border: 1px solid;">ลำดับ</th>
                                        <th style="width: 10%; border: 1px solid;">รหัสบัตรประชาชน</th>
                                        <th style="width: 28%; border: 1px solid;">ชื่อ-นามสกุล</th>
                                        <th style="width: 14%; border: 1px solid;">รหัสผ่าน</th>
                            ...
                            */
                                        ?>
                                            <tr>
                                                ...
                                                <td><?php echo '' . $rsjobinfo["noffice"] . ' ';
                                                    /*
                                                if ($rsjobinfo["noffice"] == '0') {
                                                        echo "พนักงานราชการ";
                                                ...
                                                <td><a href="resetpass.php?noman=<?php echo $rsjobinfo["noman"]; ?>" data-toggle="
